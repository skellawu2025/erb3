...
module.exports = function(XRegExp) {
    ...
    XRegExp.addUnicodeData([
        ...
        {
            name: 'InIdeographic_Admission_criteria_Characters',
            bmp: '\u2FF0-\u2FFF'
        },
        {
...
module.exports = function(XRegExp) {
     ...
     * category admission_criterias in UAX #44 <http://unicode.org/reports/tr44/#GC_Values_Table>. Token
 ...
 * @param {String} type Type to check for, in Course_nameCase.
